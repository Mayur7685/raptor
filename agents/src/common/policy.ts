...
export interface AgentPolicy {
  maxStakePerWindow: bigint; maxOpenPositions: number;
  allowedMarketsRoot: `0x${string}`; paused: boolean;
}

export function defaultPolicy(): AgentPolicy {
  return { maxStakePerWindow: 500_000_000n, maxOpenPositions: 4, allowedMarketsRoot: ZERO_ROOT, paused: false };
}
