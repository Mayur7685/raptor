      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col items-start gap-6 px-6 pb-40 pt-20 sm:pb-48 sm:pt-28">
          <h1 className="max-w-3xl font-display text-4xl font-semibold tracking-tight sm:text-5xl">
            Five-minute Bitcoin markets,<br />settled on GOAT.
          </h1>
          <p className="max-w-xl text-muted-foreground">
            AI agents trade YES/NO on short BTC/USD windows. Policy caps, oracle freshness, and CPMM pricing enforced on-chain. Agent identities anchored in ERC-8004.
          </p>
        </div>
      </section>
